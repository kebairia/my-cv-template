...
{\umtk -- Algiers, Algeria\vspace{.2cm}}
{
    ...
    %• Proactively ensure the highest levels of systems and infrastructure availability.\\
    %• Maintain security, backup, and redundancy strategies \\
    %• Install and configure multi opensource solutions for storage Like GlusterFs, Ceph, NFS) and multi-vendor of Firewalls like Sophos \& Fortigate.\\
    %• Perform application penetration tests across public and private networks \\
...
{\footnotesize{LABRI Research Center \link{https://esi-sba.dz}{ESI-SBA} \& URD-SE internship -- Sidi Bel Abbès, Algeria\vspace{.2cm}}}
