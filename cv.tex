...
\section{Awards}
\begin{itemize}
  \item \textbf{1st Place} (nationally) in  Graphic Design category \emph{Festival ``\textbf{Bahjah}''}

  \item MLH orgnized by Github \& Microsoft \emph{ESI-SBA ``\textbf{2019}''}

  \item \textbf{6th/30 Place} Coding Challenge \emph{ESI-SBA ``\textbf{2019}''}
\end{itemize}
%%}}}
